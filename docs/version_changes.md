...
* [ci(voronoi)](https://github.com/modflowpy/flopy/commit/844c216d36814278f588e8085df9b5bd40be7b0e): Test script was not running (#1255). Committed by langevin-usgs on 2021-10-05.
* [ci](https://github.com/modflowpy/flopy/commit/fb0a3e649f4da72ce3e8d378e81c79fcdfa7500b): Add workflow to test flopy-based MODFLOW 6 tests (#1272). Committed by jdhughes-usgs on 2021-10-21.
* [ci](https://github.com/modflowpy/flopy/commit/c70aebb72ced625d9f4b71676fbab805ca819a72): Convert from nosetest to pytest (#1274). Committed by jdhughes-usgs on 2021-10-29.
* [ci](https://github.com/modflowpy/flopy/commit/797ca8a95fffbd64c71532706333fc08925135bb): Convert addition autotests to use flopyTest testing framework (#1276). Committed by jdhughes-usgs on 2021-10-30.
* [ci](https://github.com/modflowpy/flopy/commit/2014dd89a2768ce1a0242083456568ee43265f6c): Convert addition autotests to use flopyTest testing framework (#1278). Committed by jdhughes-usgs on 2021-11-01.
* [ci](https://github.com/modflowpy/flopy/commit/528ac7474bbc0c9d1486e8ccae2e8f74d77d9e83): Refactor FlopyTestSetup testing class (#1283). Committed by jdhughes-usgs on 2021-11-02.
* [ci](https://github.com/modflowpy/flopy/commit/d2487345038c5f7b593494d4275bfc18031ce25e): Switch from conda to standard python and pip (#1293). Committed by jdhughes-usgs on 2021-11-12.
* [ci](https://github.com/modflowpy/flopy/commit/c253bab45409d2c01705494aef2b8532e6da08a0): Update t058 to fix issue on macos with python 3.9 (#1320). Committed by jdhughes-usgs on 2021-12-20.
* [ci](https://github.com/modflowpy/flopy/commit/831771dad7f2daca7c2a94bcfbef6a38ce3d0e22): Add separate windows workflow that uses miniconda (#1324). Committed by jdhughes-usgs on 2022-01-07.
* [ci(diagnose)](https://github.com/modflowpy/flopy/commit/40670221d1d16e2220403d672476df58b74b23b2): Create failedTests artifact (#1327). Committed by langevin-usgs on 2022-01-14.
* [ci](https://github.com/modflowpy/flopy/commit/9cc6e3ecf27e35ff6915a8e64468a89d92b13aaa): Add isort to linting step (#1343). Committed by jdhughes-usgs on 2022-02-01.
* [ci](https://github.com/modflowpy/flopy/commit/2160ba6f049a91ba2ed28fc51bee851b92713f7c): Restrict use of pyshp=2.2.0 until ci failure issue resolved (#1345). Committed by jdhughes-usgs on 2022-02-04.
* [ci](https://github.com/modflowpy/flopy/commit/7c9268c74b2d2769d96d10f6b0e01b3823b4b447): Remove pyshp version restriction (#1439). Committed by w-bonelli on 2022-07-06.
* [ci](https://github.com/modflowpy/flopy/commit/ed4f8d3f485ce0016090023a23d013d6667099d2): Remove requirements.txt (#1440). Committed by w-bonelli on 2022-07-07.
* [ci(rtd)](https://github.com/modflowpy/flopy/commit/e27836973bd5db110d245f08efd1df946dbba279): Downgrade rtd python version to highest supported (3.8) (#1451). Committed by jdhughes-usgs on 2022-07-18.
* [ci](https://github.com/modflowpy/flopy/commit/5d0f5857d5ca5d5a92ad9207e0d8340acc214afa): Update CI testing workflows (#1477). Committed by w-bonelli on 2022-08-04.
* [ci](https://github.com/modflowpy/flopy/commit/76b370906a806ae5bb40070ae7f61b401dc12636): Fix benchmark steps, disable dependency caching until resolution of https://github.com/actions/runner/issues/1840 (#1494). Committed by w-bonelli on 2022-08-11.
* [ci](https://github.com/modflowpy/flopy/commit/673df50134659098618e98b60b75763da56e3cf3): Use modflowpy/install-modflow-action and install-gfortran-action (#1537). Committed by w-bonelli on 2022-09-13.
* [ci](https://github.com/modflowpy/flopy/commit/5a9bec23a80d274f2a6bd528cfd3515418e11b66): Use micromamba, misc updates (#1604). Committed by w-bonelli on 2022-10-31.
* [ci](https://github.com/modflowpy/flopy/commit/1b0c213526c0a9f6ec2cd1489a0bf729b7550ae7): Debug release.yml. Committed by w-bonelli on 2022-12-12.
* [ci](https://github.com/modflowpy/flopy/commit/2eee5d2021056e9b0b71c9c2b9edfb3f3c189c9f): Remove timeout from build job in release.yml. Committed by w-bonelli on 2022-12-12.
* [ci](https://github.com/modflowpy/flopy/commit/1767e5d766099d63dc4ff279be7d5318caed58fd): Debug release.yml. Committed by w-bonelli on 2022-12-12.
* [ci](https://github.com/modflowpy/flopy/commit/e7f8137baf6f62dbb4e0e220840610829f045a30): Use internal get-modflow instead of install-modflow-action, update plugins before testing, run tests before uploading distribution in release.yml. Committed by w-bonelli on 2022-12-12.
* [ci](https://github.com/modflowpy/flopy/commit/f5cc30d9bd84c8b62150b5f1868acb342341e59d): Debug. Committed by w-bonelli on 2022-12-12.
* [ci](https://github.com/modflowpy/flopy/commit/c38188213694882913494068dfc0d69378c32f0b): Add name to release.yml. Committed by w-bonelli on 2022-12-13.

#### Docs

* [docs](https://github.com/modflowpy/flopy/commit/d42bde148ad8f27e9c8722177a9719b7f0c4a846): Initialize development branch. Committed by jdhughes-usgs on 2021-08-07.
* [docs](https://github.com/modflowpy/flopy/commit/3273d5b50e054c898b1e6365a57ce0f482d3585d): Update mf6 output tutorial (#1175). Committed by jdhughes-usgs on 2021-08-07.
* [docs](https://github.com/modflowpy/flopy/commit/b76b34085d0a14dbbc728dee4fd7b003d8cefc43): Update binder yml (#1178). Committed by jdhughes-usgs on 2021-08-09.
* [docs](https://github.com/modflowpy/flopy/commit/f0972e1ed93b1b69a750946c99e22431ec90aa42): Update README.md badges and script to update badge branch (#1206). Committed by jdhughes-usgs on 2021-08-20.
* [docs(readme)](https://github.com/modflowpy/flopy/commit/cf9c24fc960d238f0f8811314cd4102e2058da46): Update mf6 quickstart to use plot_vector() (#1215). Committed by langevin-usgs on 2021-08-25.
* [docs](https://github.com/modflowpy/flopy/commit/452d9ab5d45d73fe0dcb39987df870ba86f4e667): Black formatting of mfhob. Committed by Joseph D Hughes on 2021-09-07.
* [docs](https://github.com/modflowpy/flopy/commit/53734e56d72d19e256a2d39a7ddf8f7d9b33ef4a): Update mf6 notebooks to use latest functionality for accessing output (#1404). Committed by jdhughes-usgs on 2022-05-03.
* [docs(lgr)](https://github.com/modflowpy/flopy/commit/2ecef162718e90a05bfadb7b7f1d93e49dfbae4c): Update lgr notebook for transport (#1411). Committed by langevin-usgs on 2022-05-06.
* [docs](https://github.com/modflowpy/flopy/commit/12bb01dec6108b38c288f2a2b51f1b79abb20dbc): Devdocs updates (#1438). Committed by w-bonelli on 2022-07-06.
* [docs](https://github.com/modflowpy/flopy/commit/cbc6fd30ca8a965d5edbd266eb11bb5f5c2b8bc6): Add conda environment info and update testing guidelines in DEVELOPER.md (#1454). Committed by w-bonelli on 2022-07-20.
* [docs](https://github.com/modflowpy/flopy/commit/65698fb27eebda696129299b52c89c8844ac2ea4): Add issue templates. Committed by jdhughes-usgs on 2022-08-15.
* [docs](https://github.com/modflowpy/flopy/commit/c386c6607f8ba6cfcefc5e18474142e1f8cb857b): Update working_stack example (#1518). Committed by jdhughes-usgs on 2022-08-26.
* [docs](https://github.com/modflowpy/flopy/commit/44deee705b12f8e47e06c96062b0f8ffb178eb02): Add python version classifiers to setup.cfg, fix/update readme badges (#1600). Committed by w-bonelli on 2022-10-21.
* [docs](https://github.com/modflowpy/flopy/commit/869787af72377fee325586cd3f844d0cb0b2dcb5): Update to disclaimer (#1630). Committed by jdhughes-usgs on 2022-12-06.
...
* [fix(get-modflow)](https://github.com/modflowpy/flopy/commit/77dfc8f4486ca22a3c6aca0ea526cdea1eafd828): Ignore code.json in modflow6* repos until format standardized. Committed by w-bonelli on 2022-12-12.
* [fix(misc)](https://github.com/modflowpy/flopy/commit/5651f5fe49d41fb8ba12cab5f1c70e64f31ae91d): Miscellaneous fixes/tidying. Committed by w-bonelli on 2022-12-12.
...
* [refactor(scripts/ci)](https://github.com/modflowpy/flopy/commit/a606afb7e94db79adf7005f0e945d533cf0afbe1): Refactor dist scripts, automate release. Committed by w-bonelli on 2022-12-01.

#### Style

* [style](https://github.com/modflowpy/flopy/commit/5d4324ddb6ed5abad231295d63e28cdf779e5e07): Use f-strings to format str (#1212). Committed by Mike Taves on 2021-08-30.
* [style(import)](https://github.com/modflowpy/flopy/commit/16b84e8e7933b98c63eaa4fbeb47f6e28a45d611): Consistently use relative imports (#1330). Committed by Mike Taves on 2022-01-21.
* [style(imports)](https://github.com/modflowpy/flopy/commit/a13f8b940c9057d18732d8d49ec25d2b9b2f362e): Use isort tool, remove unused imports (#1341). Committed by Mike Taves on 2022-02-01.

#### Test

* [test](https://github.com/modflowpy/flopy/commit/28006e3024f954d3e833108fa3eb922baa1d9221): Update t504/t505 tests to write output to temp folder, update docstrings in export utils (#1444). Committed by w-bonelli on 2022-07-14.
* [test](https://github.com/modflowpy/flopy/commit/10b891f0baf0146705fb915f2e66c727d1a4aaaa): Use pytest fixtures and features (#1450). Committed by w-bonelli on 2022-07-19.
* [test(pytest)](https://github.com/modflowpy/flopy/commit/2749f16765b70d842940f4be79c169aa0c03ee74): Refactor autotests (#1458). Committed by w-bonelli on 2022-08-01.
* [test](https://github.com/modflowpy/flopy/commit/eeee27efe1f463e90eb80f7a7724356ed80b0ed8): Update tests after feedback (#1475). Committed by w-bonelli on 2022-08-02.
* [test](https://github.com/modflowpy/flopy/commit/861d5568b20e0c984116172a0d42fc82fcef459e): Support performance profiling (#1483). Committed by w-bonelli on 2022-08-05.
* [test](https://github.com/modflowpy/flopy/commit/d892182383a67c8eb5ca470eba3c992e8ba81fe4): Refine pytest skip framework, improve confest.py (#1486). Committed by Mike Taves on 2022-08-08.
* [test](https://github.com/modflowpy/flopy/commit/bf45dffe5745b9e5dc95b5cd070d9db251635bac): Update pytest framework. Committed by Wes Bonelli on 2022-08-10.
* [test](https://github.com/modflowpy/flopy/commit/8cf21f451bea2b6503803d2dbd045b6c746d57f5): Update tests (#1522). Committed by w-bonelli on 2022-09-01.
* [test(binaryfile)](https://github.com/modflowpy/flopy/commit/c116284ef2e79b840d31d4830ae32d90f0101938): Add tests for head and budget file precision detection (#1578). Committed by w-bonelli on 2022-10-13.
* [test](https://github.com/modflowpy/flopy/commit/1304e46b1eb86ede29d60ce8b75a80e4947a5a8a): Retry test_lgr.py::test_simplelgr (#1623). Committed by w-bonelli on 2022-11-08.
* [test](https://github.com/modflowpy/flopy/commit/60b35d5aad1594ce58a8f6d83a4e56b8434f0287): Mark test_export.py::test_polygon_from_ij_with_epsg flaky (#1624). Committed by w-bonelli on 2022-11-08.
