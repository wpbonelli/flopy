...
class ModflowPrtprp(mfpackage.MFPackage):
    ...
    stop_at_weak_sink : boolean
        * stop_at_weak_sink (boolean) is a text keyword to indicate that a
          ...
          sinks.
    istopzone : double
        * istopzone (double) integer value defining the stop zone number. If
    ...
    output_for_inactive : boolean
        * output_for_inactive (boolean) is a text keyword to indicate that
          output is to be written for inactive particles. By default, output is
          not written for inactive particles.
    drape : boolean
    ...
    dfn = [
           ...
           ["block options", "name stop_at_weak_sink", "type keyword",
            "reader urword", "optional true"],
           ["block options", "name istopzone", "type double precision",
            "reader urword", "optional true"],
           ["block options", "name output_for_inactive", "type keyword",
            "reader urword", "optional true"],
           ...
           ["block period", "name releasesetting",
            "type keystring all first frequency steps", "shape",
            "tagged false", "in_record true", "reader urword"],
    ...
    def __init__(self, model, loading_package=False, boundnames=None,
                 ...
                 istopzone=None, output_for_inactive=None, drape=None,
        ...
        self.output_for_inactive = self.build_mfdata("output_for_inactive",
                                                     output_for_inactive)
