...
class ModflowGwfnpf(mfpackage.MFPackage):
    ...
    dfn = [
           ...
           ["block options", "name dev_modflownwt_upstream_weighting",
            "type keyword", "reader urword", "optional true",
            "mf6internal inwtupw"],
           ["block options", "name dev_minimum_saturated_thickness",
    ...
    def __init__(self, model, loading_package=False, save_flows=None,
                 ...
                 dev_minimum_saturated_thickness=None, dev_omega=None,
        ...
        self.dev_minimum_saturated_thickness = self.build_mfdata(
            "dev_minimum_saturated_thickness",
            dev_minimum_saturated_thickness)
