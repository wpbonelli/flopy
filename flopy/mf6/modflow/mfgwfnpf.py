...
class ModflowGwfnpf(mfpackage.MFPackage):
    ...
    dfn = [
           ...
           ["block options", "name tvk_filerecord",
            "type record tvk6 filein tvk_filename", "shape", "reader urword",
           ...
           ["block options", "name filein", "type keyword", "shape",
            "in_record true", "reader urword", "tagged true",
            "optional false"],
           ["block options", "name tvk_filename", "type string",
    ...
    def __init__(self, model, loading_package=False, save_flows=None,
                 ...
                 tvk_filerecord=None, icelltype=0, k=1.0, k22=None, k33=None,
        ...
        self.tvk_filerecord = self.build_mfdata("tvk_filerecord",
                                                tvk_filerecord)
