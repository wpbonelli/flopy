...
class ModflowGwtsft(mfpackage.MFPackage):
    ...
    dfn = [
           ...
           ["block packagedata", "name packagedata",
            "type recarray rno strt aux boundname", "shape (maxbound)",
            "reader urword"],
    ...
    def __init__(self, model, loading_package=False, flow_package_name=None,
                 ...
                 obs_filerecord=None, packagedata=None, reachperioddata=None,
