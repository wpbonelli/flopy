...
class ModflowGwtcnc(mfpackage.MFPackage):
    ...
    obs_filerecord : [obs6_filename]
        * obs6_filename (string) name of input file to define observations for
          the Constant Concentration package. See the "Observation utility"
          section for instructions for preparing observation input files.
          Tables reftable:gwf-obstypetable and reftable:gwt-obstypetable lists
