...
class ModflowGwtmwt(mfpackage.MFPackage):
    ...
    def __init__(self, model, loading_package=False, flow_package_name=None,
                 ...
                 obs_filerecord=None, packagedata=None, mwtperioddata=None,
