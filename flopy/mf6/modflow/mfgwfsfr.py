...
class ModflowGwfsfr(mfpackage.MFPackage):
    ...
    obs_filerecord : [obs6_filename]
        * obs6_filename (string) name of input file to define observations for
          ...
          observation type(s) supported by the SFR package.
    mover : boolean
    ...
    dfn = [
           ...
           ["block crosssections", "name crosssections",
            "type recarray rno tab6 filein tab6_filename", "shape", "valid",
            "optional false", "reader urword"],
           ["block crosssections", "name rno", "type integer", "shape",
            "tagged false", "in_record true", "reader urword",
            "numeric_index true"],
           ...
           ["block period", "name cross_sectionrecord",
            ...
            "tagged", "in_record false", "reader urword"],
    ...
    def __init__(self, model, loading_package=False, auxiliary=None,
                 ...
                 package_convergence_filerecord=None, ts_filerecord=None,
                 obs_filerecord=None, mover=None,
                 maximum_picard_iterations=None, maximum_iterations=None,
                 maximum_depth_change=None, unit_conversion=None,
                 nreaches=None, packagedata=None, crosssections=None,
                 connectiondata=None, diversions=None, perioddata=None,
