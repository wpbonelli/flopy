...
class ModflowGwfcsub(mfpackage.MFPackage):
    ...
    def __init__(self, model, loading_package=False, boundnames=None,
                 ...
                 obs_filerecord=None, ninterbeds=None, maxsig0=None,
