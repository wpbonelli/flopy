...
class ModflowGwtlkt(mfpackage.MFPackage):
    ...
    obs_filerecord : [obs6_filename]
        * obs6_filename (string) name of input file to define observations for
          the LKT package. See the "Observation utility" section for
    ...
    dfn = [
           ...
           ["block packagedata", "name packagedata",
            "type recarray lakeno strt aux boundname", "shape (maxbound)",
            "reader urword"],
    ...
    def __init__(self, model, loading_package=False, flow_package_name=None,
                 ...
                 budgetcsv_filerecord=None, ts_filerecord=None,
                 obs_filerecord=None, packagedata=None, lakeperioddata=None,
